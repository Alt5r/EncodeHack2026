...
class AircraftModel(StrEnum):
    """Supported fixed-wing air-support visual models."""
...
class CommandAction(StrEnum):
    ...
    DROP_AIR_SUPPORT = "drop_air_support"
...
class AirSupportPayload(StrEnum):
    """Payload types available for fixed-wing air support."""
...
class AirSupportPhase(StrEnum):
    """Lifecycle phases for a transient air-support mission."""
...
class TreatedCellState(BaseModel):
    """Residual water or retardant effect on one grid cell."""
...
class AirSupportMission(BaseModel):
    """Transient fixed-wing mission rendered on the map."""
